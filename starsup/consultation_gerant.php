	...
	<!-- Header -->
		<div id="header">
			<div id="nav-wrapper"> 
				...
				<nav id="nav">
					<ul>
						<li class="active"><a href="index_gerant.php">Accueuil</a></li>
...
$req = $dbh->query('SELECT * FROM visiter as V Inner join hebergement as H on V.ID_HEBERGEMENT = H.ID_HEBERGEMENT Inner join gerer as G On V.ID_HEBERGEMENT = G.ID_HEBERGEMENT
				   WHERE YEAR(DATE_HEURE_VISITE) = "'.$_POST['date'].'" AND ID_GERANT="'.$_SESSION['id_gerant'].'" ORDER BY DATE_HEURE_VISITE DESC');
while ($donnees = $req->fetch())
{
     echo '<br>';
